...
Phases 0–8a are complete: project foundation, approved architecture (ADR-001
...
and asset management (backend API).



Phase 8b — Asset Management Frontend UI is next. See `TASKS.md` for the
