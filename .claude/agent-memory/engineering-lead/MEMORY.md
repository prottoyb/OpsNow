...
- [No Docker on the dev machine](project_no_docker_on_dev_machine.md) — as of 2026-09-22 container work can be written but never built locally; CI is the first real build.
